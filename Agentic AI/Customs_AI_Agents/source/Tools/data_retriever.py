...
from config import TARIFF_URL, VALUATION_URL, VALUATION_TOKEN, TARIFF_TOKEN
...
def fetch_tariff_data(
    ...
    headers = {
        "Authorization": f"Bearer {TARIFF_TOKEN}"
    }
...
def fetch_valuation_data(
    ...
    url = f"{VALUATION_URL}{hs_code}/"
    headers = {
        "Content-Type": "application/json",
        "Authorization": f"Bearer {VALUATION_TOKEN}"
    }
